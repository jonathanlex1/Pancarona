...
**1. How many customers have churned compared to those who were retained?**

![alt text](imgs/image.png)

Customer retention is at 73.4%, outpacing churn at 26.5% by 46.9%, suggesting a stable and loyal customer base.

**2. What is the total charges paid by churned customers versus retained customers?**
...
**3. How many churn cases occurred among customers with a significant difference between actual charges(```Totalcharges```) paid and expected charges?**
...
**4. What are the average monthly charges for churned and retained customers?**
...
**5. How is churn distributed across different tenure ranges ?** 
...
**7. What is the average number of services subscribed by churned and retained customers ?**

<<<<<<< HEAD
![alt text](imgs\imag   e-7.png)
=======
![alt text](imgs/image-7.png)
>>>>>>> f96fb76c5b632aab70d651b646cfa6952a05ce8f
...
**8. Which specific services are more associated with churn ?**
...
**9. Which specific internet service is more associated with churn ?** 
...
**10. How many additional services (beyond basic internet service) are subscribed by churned customers?**
...
**11. Which additional services are most frequently used by churned customers who subscribe to fiber optic internet?**
...
**12. What is the average tenure of customers without dependents?** 
...
**13. How much is monthly charges for customers with dependents compared to not dependents ?**
...
**14. Which type of internet service is most commonly used by customers without dependents ?**
...
**15. What is the churn distribution between customers with dependents and those without dependents ?**
